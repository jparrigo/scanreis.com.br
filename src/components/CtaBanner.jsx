...
export default function CtaBanner() {
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(135deg, #E6A800 0%, #FFC124 50%, #FFD166 100%)",
      }}
    >
      {/* Grid overlay */}
      <div
      ...
      <div
        ...
        aria-hidden
      >
        <span className="font-headline font-black text-[18vw] text-black/10 leading-none select-none whitespace-nowrap">
          SCANREIS
        </span>
      </div>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="reveal font-body text-white/80 text-lg lg:text-xl max-w-2xl mx-auto mb-10 leading-relaxed delay-200">
          Solicite um orçamento agora mesmo via WhatsApp. Nossa equipe vai
          analisar sua necessidade e apresentar a melhor solução para o seu
          negócio.
        </p>
        ...
        <div className="reveal flex flex-col sm:flex-row items-center justify-center gap-4 delay-300">
          ...
          >
            <MessageCircle className="w-5 h-5 text-[#FFC124]" />
            Solicitar Orçamento no WhatsApp
            <ArrowRight className="w-4 h-4" />
          </a>
          <div className="font-body text-black text-sm text-center">
            <div>Resposta garantida em até 2h</div>
            <div className="text-xs text-black">Seg–Sex · 08h–18h</div>
          </div>
        </div>
